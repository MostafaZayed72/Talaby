<template>
  <div class="flex flex-col items-center p-6">
    ...
    <div v-else-if="userData" class="bg-green-200 shadow-md rounded-lg md:w-[50%] md:mt-20 py-6 px-10">
      ...
      <button
        class="mt-4 bg-violet-950 text-white px-4 py-2 rounded hover:bg-violet-800 mx-auto text-center flex justify-center delayed"
    ...
    <Dialog v-model:visible="showEditDialog" :header="$t('Edit Data')" :closable="true" :modal="true"
      ...
      <form @submit.prevent="updateUserData">
        ...
        <div class="mt-6 flex justify-end">
          ...
          <button type="submit" class="bg-violet-950 text-white px-4 py-2 rounded hover:bg-violet-800">
            {{ $t('Save') }}
          </button>
        </div>
      </form>
