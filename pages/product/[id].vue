    ...
    <div v-if="product" class="flex flex-col  gap-6 w-full mx-auto justify-center items-center">
      ...
      <div class="space-y-4 text-center">
        ...
        <div class="flex flex-col items-center space-x-4">
          ...
          <div class="text-lg font-semibold text-violet-700 dark:text-violet-500">Commission: ${{
            product.commission.toFixed(2) }}</div>
        </div>

        <div class="flex gap-8 justify-center">
          <h1 class="bg-violet-950 text-white hover:bg-violet-600 delayed px-3 cursor-pointer rounded">{{ $t('Buy Now')
            }}
          </h1>
